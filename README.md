...
![Drag/drop refactor before](vscode-ext-drag-py/media/drag-drop-refactor-before.png)

### Drag/Drop Refactor After

![Drag/drop refactor after](vscode-ext-drag-py/media/drag-drop-refactor-after.png)

### CodeT5 Summarizer Results

![CodeT5 summarizer results](vscode-ext-drag-py/media/summarizer_results.png)
